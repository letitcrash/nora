...
- (void)drawBadgeForRow:(NSInteger)rowIndex inRect:(NSRect)badgeFrame
{
	...
	//Draw the badge text //not using actual value - ignore warning
	NSAttributedString *badgeAttrString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"A", (long)[self badgeValueForItem:rowItem]]
