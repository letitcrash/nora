...
#define kDMTabBarGradientColor_Start [NSColor colorWithCalibratedWhite:0.98 alpha:1.0];
#define kDMTabBarGradientColor_End   [NSColor colorWithCalibratedWhite:0.88 alpha:1.0];
...
#define kDMTabBarItemWidth                                  35.0f
...
- (void) setTabBarItems:(NSMutableArray *)newTabBarItems {
